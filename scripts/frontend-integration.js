 ...
 * This file demonstrates how to integrate Forgeraft with a web frontend
 */

// For React/Vue/Angular applications
export class ForgeraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgeraftClient(provider, contractAddress);
